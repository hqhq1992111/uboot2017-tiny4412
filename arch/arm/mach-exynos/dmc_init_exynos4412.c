...
{
    #if 0
	printascii("[SPL] DDR3 SDRAM test:start at 0x40000000, 1GB\n");
    dram_rw_test(0x40000000, (1UL << 30));
	printascii("test end\n");
    #endif
}	
#endif
...
void dram_rw_test(unsigned int start_address, unsigned int bytes)
{
	unsigned int *p;
	int i, j;
	printascii("\r\nW\n");
